...
class EagleVerifyInputV2Mixin:
    ...
    def sample(
        ...
        # NOTE: keep this in sync with EagleVerifyInput.verify() in eagle_info.py
        # (spec v1) and the equivalent calls in dflash_info.py / ngram_info.py;
        # otherwise CLPs (e.g. KimiK25ReasoningEosRedirect*) are silently
        # bypassed on the spec v2 verify path.
